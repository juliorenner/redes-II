...
NS_LOG_COMPONENT_DEFINE ("topology_3_olsr");
...
*/
  ...
  AnimationInterface anim ("topology_3_olsr.xml");

  anim.EnablePacketMetadata();
  anim.EnableIpv4RouteTracking ("topology_3_routing_olsr.xml", Seconds(1), Seconds(180), Seconds(1));
