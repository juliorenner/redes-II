...
NS_LOG_COMPONENT_DEFINE ("topology_2_olsr");
...
//      C    D
  ...
  AnimationInterface anim ("topology_2_olsr.xml");

  anim.EnablePacketMetadata();
  anim.EnableIpv4RouteTracking ("topology_2_routing_olsr.xml", Seconds(1), Seconds(180), Seconds(1));
